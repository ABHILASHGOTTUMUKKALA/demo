...
loaded_model = pickle.load(open(r'C:\Users\abhil\Downloads\Streamlit\model_pickle_XGB','rb'))
...
def main():
    ...
    if st.button('Submit'):
        features = [account_length, voice_mail_plan, customer_service_calls, international_plan, total_charge, Total_calls]
        features_list = np.array(features, dtype=object)
        Predict = Churn_prediction(features_list)
